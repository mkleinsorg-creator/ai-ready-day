...
# Letzter Schritt — Claude Code Login
echo ""
echo "════════════════════════════════════════════════"
echo "  Fast fertig!"
echo "════════════════════════════════════════════════"
echo ""
say "Letzter Schritt: Du loggst dich gleich mit deinem falkemedia-Claude-Account ein."
echo "    Browser geht von selbst auf. Anmelden, fertig."
echo ""
read -p "    Bereit? Drück Enter, um Claude Code zu starten. " _
claude login || say "Login übersprungen — du kannst das später mit 'claude login' nachholen."
...
echo ""
echo "    1.  cd ~/ai-ready-day"
echo "    2.  claude"
echo "    3.  Im Claude-Fenster:  /load prompts/00-router.md"
echo ""
echo "════════════════════════════════════════════════"
echo ""
